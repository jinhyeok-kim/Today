...
public class AlarmActivity extends AppCompatActivity{
        ...
        Button.OnClickListener bClickListener = new View.OnClickListener(){
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    case R.id.button:
                        new TimePickerDialog(AlarmActivity.this, sTimeSetListener, Time.get(Calendar.HOUR_OF_DAY),
    ...
    void setRepeatAlarm(){
        ...
        //정해진 시간에 알람 설정
        alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, Time.getTimeInMillis(), 20000,
                ServicePending);
